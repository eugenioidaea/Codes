...
if compareAdsDiff:
    ...
    plt.plot(timeLinSpaced[::2]/tauD1, np.log(liveParticlesInTimeNormD1[::2]), 'o', markerfacecolor='none', markeredgecolor='blue', markersize='5', label=r'$\tau_d = 4$')
    plt.plot(timeLinSpaced[::20]/tauD01, np.log(liveParticlesInTimeNormD01[::20]), 'o', markerfacecolor='none', markeredgecolor='red', markersize='5', label=r'$\tau_d = 40$')
    plt.plot(timeLinSpaced[::100]/tauD001, np.log(liveParticlesInTimeNormD001[::100]), 'o', markerfacecolor='none', markeredgecolor='green', markersize='5', label=r'$\tau_d = 400$')
    plt.plot(timeLinSpaced[::300]/tauD0001, np.log(liveParticlesInTimeNormD0001[::300]), 'o', markerfacecolor='none', markeredgecolor='purple', markersize='5', label=r'$\tau_d = 4000$')
    yD1 = np.exp(-0.046-0.62*(timeLinSpaced/tauD1))
    plt.plot(timeLinSpaced/tauD1, np.log(yD1), color='blue')
    yD01 = np.exp(-0.15-0.85*(timeLinSpaced/tauD01))
    plt.plot(timeLinSpaced/tauD01, np.log(yD01), color='red')
    # plt.text((timeLinSpaced/tauD01)[5000], yD01[5000], "k(t)=-0.5", fontsize=12) 
    yD001 = np.exp(-0.2-0.94*(timeLinSpaced/tauD001))
    plt.plot(timeLinSpaced/tauD001, np.log(yD001), color='green')
    # plt.text((timeLinSpaced/tauD001)[7000]*0.3, yD001[7000], "k(t)=-1.2", fontsize=12)
    yD0001 = np.exp(-0.21-0.97*(timeLinSpaced/tauD0001))
    plt.plot(timeLinSpaced/tauD0001, np.log(yD0001), color='purple')
    # plt.text((timeLinSpaced/tauD001)[7000]*0.3, yD001[7000], "k(t)=-1.2", fontsize=12)
    ...
    timeReshapedD1 = (timeLinSpaced[30:80]/tauD1).reshape(-1, 1)
    ...
    timeReshapedD01 = (timeLinSpaced[200:300]/tauD01).reshape(-1, 1)
    model = LinearRegression()
    ...
    timeReshapedD001 = (timeLinSpaced[2500:3000]/tauD001).reshape(-1, 1)
    model = LinearRegression()
    ...
    timeReshapedD0001 = (timeLinSpaced[5000:6000]/tauD0001).reshape(-1, 1)
    model = LinearRegression()
...
#    plt.tight_layout()
    ...
    timeReshapedP80 = (timeLinSpaced[200:400]/tauP).reshape(-1, 1)
    model = LinearRegression()
    model.fit(timeReshapedP80, np.log(liveParticlesInTimeNormP80[200:400]))
    print(f"Coeff P08: {model.coef_}")
    print(f"Intercept P08: {model.intercept_}")

    timeReshapedP60 = (timeLinSpaced[200:400]/tauP).reshape(-1, 1)
    model = LinearRegression()
    model.fit(timeReshapedP60, np.log(liveParticlesInTimeNormP60[200:400]))
    print(f"Coef P06: {model.coef_}")
    print(f"Intercept P06: {model.intercept_}")

    timeReshapedP40 = (timeLinSpaced[200:400]/tauP).reshape(-1, 1)
    model = LinearRegression()
    model.fit(timeReshapedP40, np.log(liveParticlesInTimeNormP40[200:400]))
    print(f"Coeff P04: {model.coef_}")
    print(f"Intercept P04: {model.intercept_}")

# Reaction rates vs characteristic times ################################################################################
if reactionVsTau:
    reactionVsDifferentTau = plt.figure(figsize=(8, 8))
    plt.plot([4], [0.62], 'o', markerfacecolor='blue', markeredgecolor='blue', markersize='10', label=r'$tau_d = 4$')
    plt.plot([40], [0.85], 'o', markerfacecolor='red', markeredgecolor='red', markersize='10', label=r'$tau_d = 40$')
    plt.plot([400], [0.94], 'o', markerfacecolor='green', markeredgecolor='green', markersize='10', label=r'$tau_d = 400$')
    plt.plot([4000], [0.97], 'o', markerfacecolor='purple', markeredgecolor='purple', markersize='10', label=r'$tau_d = 4000$')
