...
plt.plot(Time400[::100], np.log(numOfLivePartTau400[::100]/num_particles), 'o', markerfacecolor='none', markeredgecolor='green', markersize='5', label=r'$\tau_d = 400$')
plt.plot(Time4000[::500], np.log(numOfLivePartTau4000[::500]/num_particles), 'o', markerfacecolor='none', markeredgecolor='purple', markersize='5', label=r'$\tau_d = 4000$')
# plt.title("Survival time distributions")
# plt.xscale('log')
# plt.yscale('log')
plt.xlabel(r'$t$')
...
plt.text(timeReshapedSemilogTau4[-20], np.log(kInterpSemilogTau4)[-20], r'$p_s = %g e^{%g t}$' % (1/np.exp(-interpSemilogTau4.intercept_), interpSemilogTau4.coef_[0]), fontsize=18, ha='left', va='bottom')
...
plt.text(timeReshapedSemilogTau40[-200], np.log(kInterpSemilogTau40)[-200], r'$p_s = %g e^{%g t}$' % (1/np.exp(-interpSemilogTau40.intercept_), interpSemilogTau40.coef_[0]), fontsize=18, ha='left', va='bottom')
...
plt.text(timeReshapedSemilogTau400[-2000], np.log(kInterpSemilogTau400)[-2000], r'$p_s = %g e^{%g t}$' % (1/np.exp(-interpSemilogTau400.intercept_), interpSemilogTau400.coef_[0]), fontsize=18, ha='left', va='bottom')
...
plt.text(timeReshapedSemilogTau4000[-2500], np.log(kInterpSemilogTau4000)[-2500], r'$p_s = %g e^{%g t}$' % (1/np.exp(-interpSemilogTau4000.intercept_), interpSemilogTau4000.coef_[0]), fontsize=18, ha='left', va='bottom')

reactionVsTau = plt.figure(figsize=(8, 8))
plt.plot(tau4, -interpSemilogTau4.coef_[0], 'o', markerfacecolor='blue', markeredgecolor='blue', markersize='10', label=r'$k(\tau_d)=%g$' % (-interpSemilogTau4.coef_[0]))
plt.plot(tau40, -interpSemilogTau40.coef_[0], 'o', markerfacecolor='red', markeredgecolor='red', markersize='10', label=r'$k(\tau_d)=%g$' % (-interpSemilogTau40.coef_[0]))
plt.plot(tau400, -interpSemilogTau400.coef_[0], 'o', markerfacecolor='green', markeredgecolor='green', markersize='10', label=r'$k(\tau_d)=%g$' % (-interpSemilogTau400.coef_[0]))
plt.plot(tau4000, -interpSemilogTau4000.coef_[0], 'o', markerfacecolor='purple', markeredgecolor='purple', markersize='10', label=r'$k(\tau_d)=%g$' % (-interpSemilogTau4000.coef_[0]))
