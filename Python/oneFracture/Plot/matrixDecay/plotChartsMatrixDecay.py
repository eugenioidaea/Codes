...
if plotMatrixDecayK:
    ...
    plt.plot(kDecay[4], abs(interpSemilogK0005.coef_[0]), 'o', markerfacecolor='green', markeredgecolor='green', markersize='10', label=r'$k_{m}=%g$' % (kDecay[4]))
    plt.plot(kDecay[5], abs(interpSemilogK0001.coef_[0]), 'o', markerfacecolor='magenta', markeredgecolor='magenta', markersize='10', label=r'$k_{m}=%g$' % (kDecay[5]))
