...
if save.upper()=="Y":
    ...
    # np.savez('compareAdsP100.npz', **variablesToSave)
    ...
    # np.savez('onlyDiff.npz', **variablesToSave)
    # np.savez('diffAndDecay.npz', **variablesToSave)
    np.savez('decayAndAdsorption.npz', **variablesToSave)
    if variablesToSave:
        print("\n RESULTS SAVED")
else:
    print("\n RESULTS NOT SAVED.")