...
plt.text(timeReshapedSemilogTau4[-20], np.log(kInterpSemilogTau4)[-20], r'$p_s=e^{%g t}/e^{%g}$' % (interpSemilogTau4.coef_[0], interpSemilogTau4.intercept_), fontsize=18, ha='left', va='bottom')
...
plt.text(timeReshapedSemilogTau40[-200], np.log(kInterpSemilogTau40)[-200], r'$p_s=e^{%g t}/e^{%g}$' % (interpSemilogTau40.coef_[0], interpSemilogTau40.intercept_), fontsize=18, ha='left', va='bottom')
...
plt.text(timeReshapedSemilogTau400[-2000], np.log(kInterpSemilogTau400)[-2000], r'$p_s=e^{%g t}/e^{%g}$' % (interpSemilogTau400.coef_[0], interpSemilogTau400.intercept_), fontsize=18, ha='left', va='bottom')
...
plt.text(timeReshapedSemilogTau4000[-30000], np.log(kInterpSemilogTau4000)[-30000], r'$p_s=e^{%g t}/e^{%g}$' % (interpSemilogTau4000.coef_[0], interpSemilogTau4000.intercept_), fontsize=18, ha='left', va='bottom')
