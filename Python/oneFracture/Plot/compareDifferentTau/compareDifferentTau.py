...
plt.plot(Time40[::10], np.log(numOfLivePartTau40[::10]/num_particles), 's', markerfacecolor='none', markeredgecolor='red', markersize='5', label=r'$\tau_d = 40$')
plt.plot(Time100[::10], np.log(numOfLivePartTau100[::10]/num_particles), '^', markerfacecolor='none', markeredgecolor='pink', markersize='5', label=r'$\tau_d = 100$')
plt.plot(Time400[::20], np.log(numOfLivePartTau400[::20]/num_particles), 'v', markerfacecolor='none', markeredgecolor='green', markersize='5', label=r'$\tau_d = 400$')
plt.plot(Time1000[::10], np.log(numOfLivePartTau1000[::10]/num_particles), 'D', markerfacecolor='none', markeredgecolor='orange', markersize='5', label=r'$\tau_d = 1000$')
plt.plot(Time4000[::20], np.log(numOfLivePartTau4000[::20]/num_particles), 'P', markerfacecolor='none', markeredgecolor='purple', markersize='5', label=r'$\tau_d = 4000$')
# plt.title("Survival time distributions")
# plt.xscale('log')
# plt.yscale('log')
plt.xlabel(r'$t$')
...
plt.plot(tau100, -interpSemilogTau100.coef_[0], '^', markerfacecolor='none', markeredgecolor='pink', markersize='10', label=r'$k(\tau_d)=%g$' % (round(-interpSemilogTau100.coef_[0], 3)))
plt.plot(tau400, -interpSemilogTau400.coef_[0], 'v', markerfacecolor='none', markeredgecolor='green', markersize='10', label=r'$k(\tau_d)=%g$' % (round(-interpSemilogTau400.coef_[0], 3)))
plt.plot(tau1000, -interpSemilogTau1000.coef_[0], 'D', markerfacecolor='none', markeredgecolor='orange', markersize='10', label=r'$k(\tau_d)=%g$' % (round(-interpSemilogTau1000.coef_[0], 3)))
plt.plot(tau4000, -interpSemilogTau4000.coef_[0], 'P', markerfacecolor='none', markeredgecolor='purple', markersize='10', label=r'$k(\tau_d)=%g$' % (round(-interpSemilogTau4000.coef_[0], 3)))
