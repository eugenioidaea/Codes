...
plt.rcParams.update({'font.size': 20})
sliceP100 = slice(0, sum(np.log(liveParticlesInTimeNormP100)>-10))
timeReshapedP100 = (TimeP100[sliceP100]).reshape(-1, 1)
yP100fit = LinearRegression().fit(timeReshapedP100, np.log(liveParticlesInTimeNormP100[sliceP100]))
...
plt.plot(TimeP100[::10], np.log(liveParticlesInTimeNormP100)[::10], 'o', markerfacecolor='none', markeredgecolor='magenta', markersize='5', label=r'$p_{ads} = 1.0$')
plt.plot(TimeP90[::10], np.log(liveParticlesInTimeNormP90)[::10], 's', markerfacecolor='none', markeredgecolor='pink', markersize='5', label=r'$p_{ads} = 0.9$')
plt.plot(TimeP80[::10], np.log(liveParticlesInTimeNormP80)[::10], '^', markerfacecolor='none', markeredgecolor='blue', markersize='5', label=r'$p_{ads} = 0.8$')
plt.plot(TimeP60[::10], np.log(liveParticlesInTimeNormP60)[::10], 'v', markerfacecolor='none', markeredgecolor='red', markersize='5', label=r'$p_{ads} = 0.6$')
plt.plot(TimeP40[::10], np.log(liveParticlesInTimeNormP40)[::10], 'D', markerfacecolor='none', markeredgecolor='green', markersize='5', label=r'$p_{ads} = 0.4$')
plt.plot(TimeP20[::10], np.log(liveParticlesInTimeNormP20)[::10], 'P', markerfacecolor='none', markeredgecolor='purple', markersize='5', label=r'$p_{ads} = 0.2$')
plt.plot(TimeP10[::10], np.log(liveParticlesInTimeNormP10)[::10], '*', markerfacecolor='none', markeredgecolor='orange', markersize='5', label=r'$p_{ads} = 0.1$')
yP100 = np.exp(yP100fit.intercept_+yP100fit.coef_[0]*(TimeP100))
# plt.plot(TimeP100, np.log(yP100), color='pink')
# plt.text(TimeP100[len(TimeP100)//2], np.log(yP100)[len(yP100)//2], r'$p_s = %g e^{%g t}$' % (round(np.exp(-yP100fit.intercept_), 2), round(yP100fit.coef_[0], 3)), fontsize=18, ha='left', va='bottom')
...
# plt.xscale('log')
# plt.yscale('log')
plt.xlim(0, max(np.max(arr) for arr in [TimeP10, TimeP20, TimeP40, TimeP60, TimeP80, TimeP90, TimeP100]))
# plt.xlim(0, 250)
plt.ylim(-10, 0.1)
...
kt = np.abs([yP10fit.coef_[0], yP20fit.coef_[0], yP40fit.coef_[0], yP60fit.coef_[0], yP80fit.coef_[0], yP90fit.coef_[0], yP100fit.coef_[0]])
reactionVsDifferentP = plt.figure(figsize=(8, 8), dpi=300)
plt.plot([1.0], kt[5], 'o', markerfacecolor='magenta', markeredgecolor='magenta', markersize='10') #, label=r'$k(p_{ads})=%g$' % (-yP100fit.coef_[0]))
plt.plot([0.9], kt[5], 's', markerfacecolor='pink', markeredgecolor='pink', markersize='10') #, label=r'$k(p_{ads})=%g$' % (-yP90fit.coef_[0]))
plt.plot([0.8], kt[4], '^', markerfacecolor='blue', markeredgecolor='blue', markersize='10') #, label=r'$k(p_{ads})=%g$' % (-yP80fit.coef_[0]))
plt.plot([0.6], kt[3], 'v', markerfacecolor='red', markeredgecolor='red', markersize='10') #, label=r'$k(p_{ads})=%g$' % (-yP60fit.coef_[0]))
plt.plot([0.4], kt[2], 'D', markerfacecolor='green', markeredgecolor='green', markersize='10') #, label=r'$k(p_{ads})=%g$' % (-yP40fit.coef_[0]))
plt.plot([0.2], kt[1], 'P', markerfacecolor='purple', markeredgecolor='purple', markersize='10') #, label=r'$k(p_{ads})=%g$' % (-yP20fit.coef_[0]))
plt.plot([0.1], kt[0], '*', markerfacecolor='orange', markeredgecolor='orange', markersize='10') #, label=r'$k(p_{ads})=%g$' % (-yP10fit.coef_[0]))
...
plt.plot(xInterp, yInterp2, label=r'$y = %g x^{2} + %g x + %g$' % (round(coefficients[0], 2), round(coefficients[1], 2), round(coefficients[2], 2)), linestyle='--', color='black')
