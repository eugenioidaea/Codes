...
plt.text(timeLinSpaced[::20][20], np.log(yP80)[::20][20], f"y={yP80fit.coef_[0]:.5f}x{yP80fit.intercept_:.5f}", fontsize=18)#, ha='left', va='top')
yP60 = np.exp(-0.11-0.017*(timeLinSpaced))
plt.plot(timeLinSpaced, np.log(yP60), color='red')
plt.text(timeLinSpaced[::20][20], np.log(yP60)[::20][20], f"y={yP60fit.coef_[0]:.5f}x{yP60fit.intercept_:.5f}", fontsize=18)#, ha='left', va='top')
yP40 = np.exp(-0.078-0.014*(timeLinSpaced))
plt.plot(timeLinSpaced, np.log(yP40), color='green')
plt.text(timeLinSpaced[::20][20], np.log(yP40)[::20][20], f"y={yP40fit.coef_[0]:.5f}x{yP40fit.intercept_:.5f}", fontsize=18)#, ha='left', va='top')
yP20 = np.exp(-0.016-0.0087*(timeLinSpaced))
plt.plot(timeLinSpaced, np.log(yP20), color='purple')
plt.text(timeLinSpaced[::20][20], np.log(yP20)[::20][20], f"y={yP20fit.coef_[0]:.5f}x{yP20fit.intercept_:.5f}", fontsize=18)#, ha='left', va='top')
plt.title("Normalised survival time distribution")
# plt.xscale('log')
# plt.yscale('log')
plt.xlim(0, 1500)
...
plt.plot([0.8], kt[3], 'o', markerfacecolor='blue', markeredgecolor='blue', markersize='10', label=r'$p_{ads} = 0.8$')
plt.plot([0.6], kt[2], 'o', markerfacecolor='red', markeredgecolor='red', markersize='10', label=r'$p_{ads} = 0.6$')
plt.plot([0.4], kt[1], 'o', markerfacecolor='green', markeredgecolor='green', markersize='10', label=r'$p_{ads} = 0.4$')
plt.plot([0.2], kt[0], 'o', markerfacecolor='purple', markeredgecolor='purple', markersize='10', label=r'$p_{ads} = 0.2$')
