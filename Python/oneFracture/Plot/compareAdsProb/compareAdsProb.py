...
plt.plot([0.8], kt[3], 'o', markerfacecolor='blue', markeredgecolor='blue', markersize='10', label=r'$k(t)=$'+f'{-yP80fit.coef_[0]:.5f}')
plt.plot([0.6], kt[2], 'o', markerfacecolor='red', markeredgecolor='red', markersize='10', label=r'$k(t)=$'+f'{-yP60fit.coef_[0]:.5f}')
plt.plot([0.4], kt[1], 'o', markerfacecolor='green', markeredgecolor='green', markersize='10', label=r'$k(t)=$'+f'{-yP40fit.coef_[0]:.5f}')
plt.plot([0.2], kt[0], 'o', markerfacecolor='purple', markeredgecolor='purple', markersize='10', label=r'$k(t)=$'+f'{-yP20fit.coef_[0]:.5f}')
