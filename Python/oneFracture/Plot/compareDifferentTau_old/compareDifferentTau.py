...
plt.text(timeReshapedSemilogTau4000[-30000], np.log(kInterpSemilogTau4000)[-30000], r'$p_s = %g e^{%g t}$' % (1/np.exp(-interpSemilogTau4000.intercept_), interpSemilogTau4000.coef_[0]), fontsize=18, ha='left', va='bottom')
