##############################################################################
#### ERROR: even though for throats distances shorter or longer than spacing between pores OpenPNM does not raise any error, if they differ from spacing the domain is not physically meaningful (throats cannot be other than straight lines)
##############################################################################
