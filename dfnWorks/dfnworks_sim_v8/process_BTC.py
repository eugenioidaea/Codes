...
Jvec = CJsolVector(time, n, x, Deff)
...
ax.plot(time, CJsolVector(time, n, x, Dmol), '-', color='orange', linewidth=3, markersize='8', label='Dmol')
ax.plot(time, Jvec, '--', color='blue', linewidth=3, label='Deff')
ax.plot(time, lsqJvec(lsqDeff), '-*', color='green', linewidth=3, markersize='8', label='lsq')
...
fig, ax = plt.subplots(figsize = (8,6))
plt.rcParams.update({'font.size': 20})
ax.plot(time, 1-Jsim, 'o', markerfacecolor='none', markeredgecolor='red', markersize='8', label='Numerical')
ax.plot(time[:-1], 1-CJsolVector(time, n, x, Dmol)[:-1], '-', color='orange', linewidth=3, markersize='8', label='Dmol')
