...
DFN.params['domainSize']['value'] = [1, 1, 2] # Minimum representative volume of the shale caprock
DFN.params['h']['value'] = 0.01 # fine grid resolution to accurately model small-scale fractures [m]
...
np.save('Aperture.npy', DFN.aperture)