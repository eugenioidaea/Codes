...
DFN.add_fracture_family(
    ...
    min_radius=1.0,
    max_radius=5.0,
    kappa=1.0, # it determines the clustering of fracture orientations: higher value indicates tighter clustering around the mean orientation
    ...
    p32=4.0, # fracture intensity in m²/m³
    ...
    number_of_points=8,
    hy_params={
        "alpha": 10**-4, # aperture scaling factor
